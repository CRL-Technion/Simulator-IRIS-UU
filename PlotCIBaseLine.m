...
for i=1:1:length(start_indices)
    h0_POI= plot(mc1(i,1),(meanPoi1(i,1)),'-*','color',colorIris,'linewidth',2);
    h1_POI= plot(mc1(i,2:end),(meanPoi1(i,2:end)),'-*','color',colorIris_u,'linewidth',2);
h2_POI =plot(mc1(i,2:end),(lowerBoundPOI1(i,2:end)),'--','color',colorBoundMean,'linewidth',2);
end
% h1= plot(mc,smooth(meanPoi),'b','linewidth',2);
% h2 =plot(mc(2:end),smooth(lowerBoundPOI),'r--','linewidth',2);
ax = gca;
ax.XAxis.TickLabels{1} = 'IRIS';
legend([h0_POI,h1_POI,h2_POI],'Avarage-IRIS','Avarage','Lower bound','location','best')
...
% h2 =plot(mc1(i,2:end),(UpperBoundCollision1(i,2:end)),'r--','linewidth',2);
    ...
    h1_coll= plot(mc1(i,2:end),(meanCollision1(i,2:end)),'-*','color',colorIris_u,'linewidth',2);
h2_coll =plot(mc1(i,2:end),(UpperBoundCollision1(i,2:end)),'--','color',colorBoundMean,'linewidth',2);
...
for i=1:1:length(start_indices)
    ...
    h1_length= plot(mc1(i,2:end),(meantotalLengthMean1(i,2:end)),'-*','color',colorIris_u,'linewidth',2);
h2_length =plot(mc1(i,2:end),(LowerBoundLength1(i,2:end)),'--','color',colorBoundMean,'linewidth',2);
    h2_length =plot(mc1(i,2:end),(UpperBoundLength1(i,2:end)),'--','color',colorBoundMean,'linewidth',2);
h3_length =plot(mc1(i,2:end),(LowerBoundLength_total1(i,2:end)),'--','color',colorBoundAll,'linewidth',2);
    h3_length =plot(mc1(i,2:end),(UpperBoundLength_total1(i,2:end)),'--','color',colorBoundAll,'linewidth',2);
...
%     h1= plot(mc1(i,:),(SearchTimeVec1(i,:)),'b*','linewidth',2);
    ...
    h1_time= plot(mc1(i,2:end),(SearchTimeVec1(i,2:end)),'-*','color',colorIris_u,'linewidth',2);
...
%%
% h_fig_1 = [h0_POI,h1_POI,h2_POI];
% h_fig_2 = [h0_coll,h1_coll,h2_coll];
% h_fig_3 =  [h0_length,h1_length,h2_length,h3_length];
% h_fig_4 =  [h0_time,h1_time];
%%
figure(1);
...
figure(3);
legend([h_fig_3(1),h1_length,h_fig_2(2),h_fig_2(3),h_fig_3(4),h2_length,h3_length],'Avarage-IRIS','Avarage-LUM','Avarage-IRIS-U^2','CI for Avarage IRIS-U^2','CI for 3\sigma IRIS-U^2','CI for Avarage LUM','CI for 3\sigma LUM','location','best','Orientation', 'horizontal')
