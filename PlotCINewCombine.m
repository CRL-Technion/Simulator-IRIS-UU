...
colorIris = [0.7 0 0];
colorLum = [0.7 0.4 0.1];
colorIris_u = [0.1 0 0.4];
colorBoundMean = [0.1 0 0.9];
colorBoundAll = [0.1 0.2 0.6];
% 
% colorIris_u = [0 0.3 0.3];
% colorBoundMean = [0,0.4,0.2];
% colorBoundAll = [0,0.7,0.3];
...
for i=1:1:length(start_indices)
    h0_POI_IRIS= plot([mc1(i,3),mc1(i,end)],[(meanPoi1(i,1)),(meanPoi1(i,1))],'r:','color',colorIris,'linewidth',2);
    h0_POI_LUM= plot([mc1(i,3),mc1(i,end)],[(meanPoi1(i,2)),(meanPoi1(i,2))],'y:','color',colorLum,'linewidth',2);
    h1_POI= plot(mc1(i,3:end),(meanPoi1(i,3:end)),'-*','color',colorIris_u,'linewidth',2);
h2_POI =plot(mc1(i,3:end),(lowerBoundPOI1(i,3:end)),'--','color',colorBoundMean,'linewidth',2);
end
% h1= plot(mc,smooth(meanPoi),'b','linewidth',2);
% h2 =plot(mc(3:end),smooth(lowerBoundPOI),'r--','linewidth',2);
% ax = gca;
% ax.XAxis.TickLabels{1} = 'IRIS';
% legend([h0_POI_IRIS,h0_POI_LUM,h1_POI,h2_POI],'Avarage-IRIS','Avarage-LUM','Avarage-IRIS-U^2','Lower bound','location','best')
...
for i=1:1:length(runNumber)
    ...
    collisionProbabilityAllEdges = mean(runNumber{i}.collisionVectorsimulation(:,3:end));
    meanCollision(i) = 1;
...
% h2 =plot(mc1(i,3:end),(UpperBoundCollision1(i,3:end)),'r--','linewidth',2);

%     h0_coll= plot(mc1(i,1),(meanCollision1(i,1)),'-*','color',colorIris,'linewidth',2);
%     h1_coll= plot(mc1(i,3:end),(meanCollision1(i,3:end)),'-*','color',colorIris_u,'linewidth',2);
% h2_coll =plot(mc1(i,3:end),(UpperBoundCollision1(i,3:end)),'--','color',colorBoundMean,'linewidth',2);

  h0_coll_IRIS= plot([mc1(i,3),mc1(i,end)],[(meanCollision1(i,1)),(meanCollision1(i,1))],'r:','color',colorIris,'linewidth',2);
    h0_coll_LUM= plot([mc1(i,3),mc1(i,end)],[(meanCollision1(i,2)),(meanCollision1(i,2))],'y:','color',colorLum,'linewidth',2);
    h1_coll= plot(mc1(i,3:end),(meanCollision1(i,3:end)),'-*','color',colorIris_u,'linewidth',2);
h2_coll =plot(mc1(i,3:end),(UpperBoundCollision1(i,3:end)),'--','color',colorBoundMean,'linewidth',2);
end
...
% h2 = plot(mc(3:end),(bound_collision(3:end,2)),'r--','linewidth',2);
% ax = gca;
% ax.XAxis.TickLabels{1} = 'IRIS';
% legend([h0_coll,h1_coll,h2_coll],'Avarage-IRIS','Avarage','Lower bound','location','best')
...
%     
%     h0_length= plot(mc1(i,1),(meantotalLengthMean1(i,1)),'-*','color',colorIris,'linewidth',2);
%     h1_length= plot(mc1(i,3:end),(meantotalLengthMean1(i,3:end)),'-*','color',colorIris_u,'linewidth',2);
% h2_length =plot(mc1(i,3:end),(LowerBoundLength1(i,3:end)),'--','color',colorBoundMean,'linewidth',2);
%     h2_length =plot(mc1(i,3:end),(UpperBoundLength1(i,3:end)),'--','color',colorBoundMean,'linewidth',2);
% h3_length =plot(mc1(i,3:end),(LowerBoundLength_total1(i,3:end)),'--','color',colorBoundAll,'linewidth',2);
%     h3_length =plot(mc1(i,3:end),(UpperBoundLength_total1(i,3:end)),'--','color',colorBoundAll,'linewidth',2);

      h0_length_IRIS= plot([mc1(i,3),mc1(i,end)],[(meantotalLengthMean1(i,1)),(meantotalLengthMean1(i,1))],'r:','color',colorIris,'linewidth',2);
    h0_length_LUM= plot([mc1(i,3),mc1(i,end)],[(meantotalLengthMean1(i,2)),(meantotalLengthMean1(i,2))],'y:','color',colorLum,'linewidth',2);
    h1_length= plot(mc1(i,3:end),(meantotalLengthMean1(i,3:end)),'-*','color',colorIris_u,'linewidth',2);
h2_length =plot(mc1(i,3:end),(LowerBoundLength1(i,3:end)),'--','color',colorBoundMean,'linewidth',2);
    h2_length =plot(mc1(i,3:end),(UpperBoundLength1(i,3:end)),'--','color',colorBoundMean,'linewidth',2);
h3_length =plot(mc1(i,3:end),(LowerBoundLength_total1(i,3:end)),'--','color',colorBoundAll,'linewidth',2);
...
%     h2 = plot(mc1(i,3:end),(LowerBoundLength1(i,3:end)),'r--','linewidth',2);
%     h2 = plot(mc1(i,3:end),(UpperBoundLength1(i,3:end)),'r--','linewidth',2);
%     h3 = plot(mc1(i,3:end),(LowerBoundLength_total1(i,3:end)),'k--','linewidth',2);
%     h3 = plot(mc1(i,3:end),(UpperBoundLength_total1(i,3:end)),'k--','linewidth',2);
end
...
% h2 = plot(mc(3:end),(bound_length_mean(3:end,1)),'r--','linewidth',2);
% h2 = plot(mc(3:end),(bound_length_mean(3:end,2)),'r--','linewidth',2);
% h3 = plot(mc(3:end),(bound_length(3:end,1)),'k--','linewidth',2);
% h3 = plot(mc(3:end),(bound_length(3:end,2)),'k--','linewidth',2);


% ax = gca;
% ax.XAxis.TickLabels{1} = 'IRIS';
% legend([h0_length,h1_length,h2_length,h3_length],'Avarage-IRIS','Avarage','CI for Avarage','CI for 3\sigma','location','best')
...
%     
%      h0_time= plot(mc1(i,1),(SearchTimeVec1(i,1)),'-*','color',colorIris,'linewidth',2);
%     h1_time= plot(mc1(i,3:end),(SearchTimeVec1(i,3:end)),'-*','color',colorIris_u,'linewidth',2);
%     
      h0_time_IRIS= plot([mc1(i,3),mc1(i,end)],[(SearchTimeVec1(i,1)),(SearchTimeVec1(i,1))],'r:','color',colorIris,'linewidth',2);
    h0_time_LUM= plot([mc1(i,3),mc1(i,end)],[(SearchTimeVec1(i,2)),(SearchTimeVec1(i,2))],'y:','color',colorLum,'linewidth',2);
    h1_time= plot(mc1(i,3:end),(SearchTimeVec1(i,3:end)),'-*','color',colorIris_u,'linewidth',2);
    
end
% for i=1:1:length(start_indices)/5
%     h1= plot(mc1(i,3:end),(SearchTimeVec1(i,3:end)),'linewidth',2);
% end
...
yticks([0.5 25 100 270 600 1670 5000])
yticks([0.001 0.005 0.01 0.05 0.2 0.5])
...
% legend([h0_time,h1_time],'Avarage-IRIS','Avarage','CI for 3\sigma','location','best')
xlim([min(mc1(1,3:end)) max(mc1)])

%%
h_fig_1 = [h0_POI_IRIS,h0_POI_LUM,h1_POI,h2_POI];
h_fig_2 = [h0_coll_IRIS,h0_coll_LUM,h2_coll];
h_fig_3 =  [h0_length_IRIS,h0_length_LUM,h1_length,h2_length,h3_length];
h_fig_4 =  [h0_time_IRIS,h0_time_LUM,h1_time];
%%
% figure(1);
% legend([h_fig_1(1),h1_POI,h_fig_1(2),h_fig_1(3)],'Avarage-IRIS','Avarage-LUM','Avarage-IRIS-U^2','Lower bound IRIS-U^2','location','best')
% figure(2);
% legend([h_fig_2(1),h1_coll,h_fig_2(2),h_fig_2(3)],'Avarage-IRIS','Avarage-LUM','Avarage-IRIS-U^2','Upper bound','location','best')
figure(3);
legend([h0_length_IRIS,h0_length_LUM,h1_length,h2_length,h3_length],'Avarage-IRIS','Avarage-LUM','Avarage-IRIS-U^2','CI for Avarage IRIS-U^2','CI for 3\sigma IRIS-U^2','location','best','Orientation', 'horizontal')
% legendHandle = findobj(gcf, 'Type', 'Legend');
% set(gcf, 'Units', 'pixels', 'Position', legendHandle.Position);

% figure(4);
% legend([h_fig_4(1),h1_time,h_fig_4(2)],'Avarage-IRIS','Avarage-LUM','Avarage-IRIS-U^2','CI for 3\sigma','location','best')
% 
