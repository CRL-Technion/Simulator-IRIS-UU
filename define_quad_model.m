...
factor = 5;
Quad.plot_arm = .3*factor;     % Distance from the center of mass to the each motor (m)
Quad.plot_arm_t = .02*factor;   %Thickness of the quadrotor's arms for drawing purposes (m)
Quad.plot_prop = .1*factor;   %Radius of the propellor (m)
